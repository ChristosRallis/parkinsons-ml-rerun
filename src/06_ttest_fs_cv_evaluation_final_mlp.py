# 06_ttest_fs_cv_evaluation_final_mlp.py
# ------------------------------------------------------------
# 3-fold CV evaluation for T-test Feature Selection + MLP using:
...
# - fixed best_k from: results/evaluation_t-test_fs_mlp/t-test_tuning_mlp/best_k_mlp.json
#
# Saves:
# - metrics per fold:   results/evaluation_t-test_fs_mlp/metrics/(1)_ttest_fs_mlp_metrics_per_fold.csv
# - summary mean±std:   results/evaluation_t-test_fs_mlp/metrics/(1)_ttest_fs_mlp_metrics_summary.csv
# - raw predictions:    results/evaluation_t-test_fs_mlp/predictions/(1)_predictions_MLP.csv
# ------------------------------------------------------------
...
BEST_K_PATH = BASE / "results" / "evaluation_t-test_fs_mlp" / \
    "t-test_tuning_mlp" / "best_k_mlp.json"

EVAL_DIR = BASE / "results" / "evaluation_t-test_fs_mlp"
...
# LOAD DATA
# ==========================================
print("Loading Data and Configuration (t-test FS MLP CV evaluation)...")
...
print("Starting 3-fold CV evaluation (t-test FS MLP)...")
print("=" * 70)
...
for fold_idx, fold_info in enumerate(folds_data["folds"]):
    ...
    # how many features selected (for reporting consistency)
...
metrics_file = METRICS_DIR / "(1)_ttest_fs_mlp_metrics_per_fold.csv"
...
summary_file = METRICS_DIR / "(1)_ttest_fs_mlp_metrics_summary.csv"
...
print("\n✅ CV Evaluation Complete (t-test FS MLP).")
