# 07_threshold_tuning_ttest_fs_constrained.py
# ------------------------------------------------------------
# Threshold tuning on out-of-fold predictions produced by:
# results/evaluation_t-test_fs/predictions/(1)_predictions_*.csv
#
# Strategy:
...
#   results/evaluation_t-test_fs/threshold_tuning/(2)_best_thresholds_constrained.csv
# - detailed metrics for all thresholds:
#   results/evaluation_t-test_fs/threshold_tuning/(2)_all_thresholds_detailed.csv
# ------------------------------------------------------------
...
PREDS_DIR = BASE / "results" / "evaluation_t-test_fs" / "predictions"
OUT_DIR = BASE / "results" / "evaluation_t-test_fs" / "threshold_tuning"
...
# 3. LOAD FILES
# ==========================================
print("Starting Constrained Threshold Tuning (Pipeline: t-test FS)...")
