# 07_threshold_tuning_no_fs_mlp_constrained.py
# ------------------------------------------------------------
# Threshold tuning on out-of-fold predictions produced by:
# results/evaluation_no_fs_mlp/predictions/(1)_predictions_MLP.csv
#
# Strategy:
...
# Saves:
# - best threshold:
#   results/evaluation_no_fs_mlp/threshold_tuning/(2)_best_threshold_constrained_mlp.csv
# - detailed metrics for all thresholds:
#   results/evaluation_no_fs_mlp/threshold_tuning/(2)_all_thresholds_detailed_mlp.csv
# ------------------------------------------------------------
...
PRED_FILE = BASE / "results" / "evaluation_no_fs_mlp" / \
    "predictions" / "(1)_predictions_MLP.csv"
OUT_DIR = BASE / "results" / "evaluation_no_fs_mlp" / "threshold_tuning"
...
# LOAD
# ==========================================
print("Starting Constrained Threshold Tuning (Pipeline: No-FS MLP)...")
...
best_out = OUT_DIR / "(2)_best_threshold_constrained_mlp.csv"
...
print(f"✅ Saved best threshold: {best_out}")
