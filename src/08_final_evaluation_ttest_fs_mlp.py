# 08_final_evaluation_ttest_fs_mlp.py
# ------------------------------------------------------------
# FINAL EVALUATION: T-TEST FEATURE SELECTION + MLP PIPELINE
#
# Uses:
# - best MLP hyperparams: results/tuning_mlp/05a_best_params_no_fs_mlp.json
# - best k:              results/evaluation_t-test_fs_mlp/t-test_tuning_mlp/best_k_mlp.json
# - tuned threshold:     results/evaluation_t-test_fs_mlp/threshold_tuning/(2)_best_thresholds_constrained_mlp.csv
#
# Trains on full external_train_samples.csv and evaluates on external_test_samples.csv
#
# Saves:
# - metrics:      results/evaluation_t-test_fs_mlp/final_test_results/final_test_metrics.csv
# - predictions:  results/evaluation_t-test_fs_mlp/final_test_results/final_test_predictions.csv
...
THRESHOLDS_PATH = BASE / "results" / "evaluation_t-test_fs_mlp" / \
    "threshold_tuning" / "(2)_best_thresholds_constrained_mlp.csv"

OUT_DIR = BASE / "results" / "evaluation_t-test_fs_mlp" / "final_test_results"
...
# EXECUTION
# ==========================================
print("🚀 Starting FINAL evaluation on EXTERNAL TEST (Pipeline: t-test FS MLP)...")
...
print(f"✅ Using best_k for MLP: {best_k}")
...
plt.title(f"MLP (k={best_k}, Th={th:.2f})\nExternal Test Confusion Matrix")
...
if len(np.unique(y_test)) == 2:
    ...
    plt.title("ROC Curve on External Test Set (t-test FS MLP)")
...
print("\n" + "=" * 70)
print("🏁 FINAL EXTERNAL TEST RESULTS (t-test FS MLP)")
print("=" * 70)
print(results_df)
print("=" * 70)
