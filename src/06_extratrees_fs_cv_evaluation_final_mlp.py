# 06_extratrees_fs_cv_evaluation_final_mlp.py
# ------------------------------------------------------------
# 3-fold CV evaluation for ExtraTrees Feature Selection + MLP using:
...
# - fixed best_k from: results/evaluation_extratrees_fs_mlp/extratrees_tuning_mlp/best_k_mlp.json
#
# Saves:
# - metrics per fold:   results/evaluation_extratrees_fs_mlp/metrics/(1)_extratrees_fs_mlp_metrics_per_fold.csv
# - summary mean±std:   results/evaluation_extratrees_fs_mlp/metrics/(1)_extratrees_fs_mlp_metrics_summary.csv
# - raw predictions:    results/evaluation_extratrees_fs_mlp/predictions/(1)_predictions_MLP.csv
# ------------------------------------------------------------
...
EVAL_DIR = BASE / "results" / "evaluation_extratrees_fs_mlp"
...
# LOAD DATA
# ==========================================
print("Loading Data and Configuration (ExtraTrees FS MLP CV evaluation)...")
...
print("Starting 3-fold CV evaluation (ExtraTrees FS MLP)...")
print("=" * 70)
...
metrics_file = METRICS_DIR / "(1)_extratrees_fs_mlp_metrics_per_fold.csv"
...
summary_file = METRICS_DIR / "(1)_extratrees_fs_mlp_metrics_summary.csv"
...
print("\n✅ CV Evaluation Complete (ExtraTrees FS MLP).")
